...
class VisitCountries extends Component {
  ...
  getVisitedCountries = () => {
    ...
    return countriesList.filter(eachCountry => eachCountry.isVisited === true)
  }
  ...
  render() {
    ...
    const noVisitedCountry = visitedCountriesList.length === 0
    ...
    return (
      <div className="app-container">
        ...
        <ul className="countries-names-container">
          ...
          <ul className="visited-countries-container">
            {visitedCountriesList.map(eachCountry => (
              <VisitedCountries
                ...
                clickDeleteCountry={this.clickDeleteCountry}
              />
            ))}
          </ul>
        )}
